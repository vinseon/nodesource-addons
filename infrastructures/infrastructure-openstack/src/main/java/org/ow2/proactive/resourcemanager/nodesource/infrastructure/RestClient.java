...
public class RestClient {
	...
	public String getInfrastructures() {
		...
		return checkResponseIsOK(infrastructuresWebResource.type("application/json").get(ClientResponse.class));
	}
	...
	public void deleteToInstancesWebResource(String infrastructureId, String key, String value) {
		WebResource instancesWebResource = jerseyClient
				.resource(connectorIaasURL + "/infrastructures/" + infrastructureId + "/instances/tag");
		checkResponseIsOK(
				instancesWebResource.queryParam(key, value).accept("application/json").delete(ClientResponse.class));
	}
